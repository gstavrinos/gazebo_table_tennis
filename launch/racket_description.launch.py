...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="The package that includes the racket description.",
        )
    )
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="racket.urdf.xacro",
            description="The racket description urdf.",
        )
    )
